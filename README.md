...
Challenges faced:
First time collaborating in a group – faced issues when using GitHub and creating ideas.
Solution: implemented a communication system for pushing and pulling from the Github page.
